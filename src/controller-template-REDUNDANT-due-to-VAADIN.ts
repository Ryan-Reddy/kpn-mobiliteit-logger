...
//         break;
//       }
//       // TODO: Logout needs work in controller-template-REDUNDANT-due-to-VAADIN.ts
//       case 'Logout': {
//         this.hideRest();
//         console.log('Logout needs work in controller-template-REDUNDANT-due-to-VAADIN.ts');
