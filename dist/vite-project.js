import "lit-html";
import {css as ne, html as b, LitElement as re} from "lit-element/lit-element.js";
...
import {css as y, html as g, LitElement as _} from "lit";
 ...
 */
const $ = window,
    M = $.ShadowRoot && ($.ShadyCSS === void 0 || $.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype,
    Y = Symbol(), N = /* @__PURE__ */ new WeakMap();
let pe = class {
    constructor(e, i, o) {
 ...
 */
var E;
const j = window, V = j.trustedTypes, ue = V ? V.emptyScript : "", I = j.reactiveElementPolyfillSupport, S = {
        toAttribute(r, e) {
            switch (e) {
                case Boolean:
                    r = r ? ue : null;
    ...
    C = {attribute: !0, type: String, converter: S, reflect: !1, hasChanged: J};
...
class w extends HTMLElement {
    ...
    _$AK(e, i) {
        ...
        if (n !== void 0 && this._$El !== n) {
            const s = t.getPropertyOptions(n),
                oe = typeof s.converter == "function" ? {fromAttribute: s.converter} : ((o = s.converter) === null || o === void 0 ? void 0 : o.fromAttribute) !== void 0 ? s.converter : S;
