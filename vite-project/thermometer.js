...
<!--            </script>-->
        ...
        <g id="fill">
                ...
                <g id="cover"><rect fill="#ffffff" height="236" id="mercury" width="40.8" x="167.4" y="105.5"></rect>
                    // thermometer fill range: heigth=(0=full)-(236=empty)
                    <polygon fill="#00C300" id="polygon"
                             points="233.7,291.3 225.8,299.9 233.7,308.5 236.8,308.5 236.8,291.3" transform="translate(0 41)"
                             xmlns="http://www.w3.org/2000/svg"></polygon> // Transform translate min = (0 41); max = (0 -200)
                            </g>
                <g id="thermometer">
