            ...
            <div id="page-container">
                <div id="content-wrap">
                    ...
                    <main>
                        ...
                        <p>Voer je e-mailadres in om je account wachtwoord te resetten.</p>
                        <form id="resetAccount">
                            <label for="email">E-mail adres:</label><input class="inputfield" id="email" name="email"
                                                                           type="email" /><br><br>
                            ...
                            <input id="stuurEmailMetWachtwoordReset" onclick="stuurWachtwoordReset()" type="button"
